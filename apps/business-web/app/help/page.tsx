...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Акция должна быть «Активна», заведение — опубликовано. На Базовом тарифе акции видны только на карточке; в городскую ленту попадают Pro и Топ города (до 2 и 5 одновременно).',
  },
  {
    q: 'Чем отличаются тарифы Базовый, Pro и Топ города?',
    a: 'Базовый — 1 акция, 5 фото, 7 дней статистики. Pro — VIP, до 5 акций, 2 в ленте, 90 дней аналитики. Топ города — слот в топе, до 10 акций, 5 в ленте. Подробнее: раздел «Тариф и продвижение».',
  },
  {
    q: 'Что будет когда тариф закончится?',
    a: 'Заведение вернётся на Базовый: снимется VIP, лишние акции станут черновиками. Уведомление придёт во «Входящие».',
  },
  {
